#!/bin/bash
################################################################################
# PotatoStack Light - Autostart & Hardening Setup
...
echo "==================================================================="
echo "PotatoStack Light - Autostart & Security Hardening"
echo "==================================================================="
...
echo "✓ Service file created at /etc/systemd/system/potatostack-light.service"

# Reload systemd
systemctl daemon-reload

# Enable the service
systemctl enable potatostack-light.service
...
echo "  sudo systemctl status potatostack-light    # Check status"
echo "  sudo systemctl start potatostack-light     # Start now"
echo "  sudo systemctl stop potatostack-light      # Stop"
echo "  sudo systemctl disable potatostack-light   # Disable autostart"
echo ""
