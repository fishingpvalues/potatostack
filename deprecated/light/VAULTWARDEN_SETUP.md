...
**Web Vault URL**: `https://192.168.178.40:8443`
...
1. Access admin panel: `https://192.168.178.40:8443/admin`
...
1. Open web browser: `https://192.168.178.40:8443`
...
4. Enter **Server URL**: `https://192.168.178.40:8443`
...
1. In browser on phone, visit `https://192.168.178.40:8443`
...
3. Enter: `https://192.168.178.40:8443`
...
4. Server URL: `https://192.168.178.40:8443`
...
Configure with server URL: `https://192.168.178.40:8443`
...
```bash
curl -k https://192.168.178.40:8443/alive
```

4. **Check firewall** (Le Potato):
```bash
sudo ufw status
...
docker compose restart vaultwarden
sleep 30  # Wait for startup on 2GB RAM device
...
Access: `https://192.168.178.40:8443/admin`
...
**Memory**: 128MB limit (adequate for 2GB device)

## URLs Summary

| Access Point | URL |
|--------------|-----|
| Web Vault | `https://192.168.178.40:8443` |
| Admin Panel | `https://192.168.178.40:8443/admin` |
| Health Check | `https://192.168.178.40:8443/alive` |
| Homepage Link | Click "Vaultwarden" card on dashboard |

**Note**: Replace `192.168.178.40` with your actual `HOST_BIND` IP from `.env`
