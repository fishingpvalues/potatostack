# PotatoStack Light - QWEN.md

## Project Overview

**PotatoStack Light** is an ultra-lean Docker Compose stack optimized for low-RAM devices, specifically designed for the Le Potato single-board computer with 2GB RAM. The stack provides a comprehensive set of services including VPN-protected P2P downloads, file synchronization, backups, and password management with a total memory footprint of approximately 1.2GB RAM.
