...
RESTART_CONTAINERS="${RESTART_CONTAINERS:-prowlarr sonarr radarr lidarr bazarr qbittorrent slskd spotiflac stash aria2}"
...
INTERNET_CHECK_INTERVAL="${INTERNET_CHECK_INTERVAL:-3}"
INTERNET_MAX_FAILURES="${INTERNET_MAX_FAILURES:-4}"
