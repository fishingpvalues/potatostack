#!/bin/bash
################################################################################
# PotatoStack Main - Autostart & Hardening Setup
...
echo "==================================================================="
echo "PotatoStack Main - Autostart & Security Hardening"
echo "==================================================================="
...
echo "[2/8] Configuring Docker daemon security..."
mkdir -p /etc/docker
...
cat > /etc/logrotate.d/potatostack-main <<'EOF'
...
cat > /etc/systemd/system/potatostack-main.service <<EOF
[Unit]
Description=PotatoStack Main - Full Stack with AI, Media, Monitoring
...
echo "✓ Service file created at /etc/systemd/system/potatostack-main.service"

# Reload systemd
systemctl daemon-reload

# Enable the service
systemctl enable potatostack-main.service
...
echo "  sudo systemctl status potatostack-main     # Check status"
echo "  sudo systemctl start potatostack-main      # Start now"
echo "  sudo systemctl stop potatostack-main       # Stop"
echo "  sudo systemctl disable potatostack-main    # Disable autostart"
echo ""
